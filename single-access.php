...
if ($loggedInUser->checkCredits()){ // if user has 1 or more credits...
	//return true, run the rest of this page;
}else{ // if user has no more credits, remove quickie access
  ...
  <div class="container content">
    ...
    <div class="row">
      ...
      <div class="col-md-9">
        ...
        <form action='scripts/single-upload.php' method='post' id="productForm" enctype='multipart/form-data' class="sky-form">
