...
<label class="form-check-label">Today's distance MINUS how many furlongs?</label><small class="form-text text-muted">&nbsp;&nbsp;i.e. WTF 50 for 1/2f, 100 for 1f, 200 for 2f, etc.</small>
