...
if(isUserLoggedIn()) {
	...
	if ($loggedInUser->checkPermission(array(1))){
		...
		$filter1=$_POST['element_2'];
		$filter2=$_POST['element_1_1'];
		$filter3=$_POST['element_6_1'];
		$filter4=$_POST['element_3'];
		$filter5=$_POST['element_7_1'];
		echo $filter5;
		$filter6=$_POST['element_4'];
		$filter7=$_POST['element_5'];
									  ...
									  foreach ($dbsheets as $sheets){
                                        ...
                                        echo "<tr style='background-color:#72c02c;text-align:center;'>
												...
												<form style='display:inline' action='scripts/summary.php' method='post' enctype='multipart/form-data' target='_blank'>
												    ...
												    <input type='hidden'  name='filter1val' value='" .$filter1. "'>
                                                ...
                                                &nbsp;&nbsp;<a href='#' data-toggle='modal' data-target='#filters'><i class='fa fa-filter'></i>&nbsp;Apply Filters</a>                                           
                                                </td>
                                                </tr>
                                                <tr>                                                
                                                <td>												
