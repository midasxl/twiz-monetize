...
goto sc;
    ...
    echo '<hr /><a href="#" id="table'.$i.'" class="filters hideRows">Show only checked rows</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="#" id="table'.$i.'" class="filters restoreRows">Restore hidden rows</a><div id="spacer"></div>
    <table class="display table'.$i.'">
    <thead>
        <th class="tooltip tooltip-top" data-tooltip="This is a tooltip.  This will hold a description of the data in this column.">Pr</th>
        <th class="tooltip tooltip-top" data-tooltip="This is a tooltip.  This will hold a description of the data in this column.">__</th>
        <th class="tooltip tooltip-top" data-tooltip="This is a tooltip.  This will hold a description of the data in this column.">Name</th>
        <th class="tooltip tooltip-top" data-tooltip="This is a tooltip.  This will hold a description of the data in this column.">m/e<b/th>
        <th class="tooltip tooltip-top" data-tooltip="This is a tooltip.  This will hold a description of the data in this column.">Ml</th>
        <th class="tooltip tooltip-top" data-tooltip="This is a tooltip.  This will hold a description of the data in this column.">J/T</th>
        <th class="tooltip tooltip-top" data-tooltip="This is a tooltip.  This will hold a description of the data in this column.">Lw</th>
        <th class="tooltip tooltip-top" data-tooltip="This is a tooltip.  This will hold a description of the data in this column.">Wk</th>
        <th class="tooltip tooltip-top" data-tooltip="This is a tooltip.  This will hold a description of the data in this column.">Wf</th>
        <th class="tooltip tooltip-top" data-tooltip="This is a tooltip.  This will hold a description of the data in this column.">Dys</th>
        <th class="tooltip tooltip-top" data-tooltip="This is a tooltip.  This will hold a description of the data in this column.">Lr</th>
        <th class="tooltip tooltip-top" data-tooltip="This is a tooltip.  This will hold a description of the data in this column.">Rf</th>
        <th class="tooltip tooltip-top" data-tooltip="This is a tooltip.  This will hold a description of the data in this column.">Jk</th>
        <th class="tooltip tooltip-top" data-tooltip="This is a tooltip.  This will hold a description of the data in this column.">Tr</th>
        <th class="tooltip tooltip-top" data-tooltip="This is a tooltip.  This will hold a description of the data in this column.">Hr</th>
        <th class="tooltip tooltip-top" data-tooltip="This is a tooltip.  This will hold a description of the data in this column.">Cl</th>
        <th class="tooltip tooltip-top" data-tooltip="This is a tooltip.  This will hold a description of the data in this column.">Sp</th>
        <th class="tooltip tooltip-top" data-tooltip="This is a tooltip.  This will hold a description of the data in this column.">Twiz</th>
        <th class="tooltip tooltip-top" data-tooltip="This is a tooltip.  This will hold a description of the data in this column.">#</th>
        <th class="tooltip tooltip-top" data-tooltip="This is a tooltip.  This will hold a description of the data in this column.">ap%</th>
        <th class="tooltip tooltip-top-left" data-tooltip="This is a tooltip.  This will hold a description of the data in this column.">rs</th>
    </thead>';
...
$somefig1= $somefig1+ ($raceperc + $somefig2  + $weighttoday - min($cw,$wkdays));
$somefig1=$somefig1-200;
$somefig1=$somefig1+max($classratingavg,$jockperc,$horseperc,$trainerperc,$speedfigureavg);
if($wkdays > $days2){
	$wkdays=$days2;
	$workperc=$raceperc;
}
...
$combinedc=$combinedc+(($pureclass-100)/10)+$bonus+$combinedc;
 ...
 if($odds1 < $odds2 AND $odds2 < $odds3 ){
	 $add20= $speedfigureavg-$l;
	 $yes="*";
 }


$somefig1=($somefig1+($add20/2))/3;
$somefig1=($somefig1-25);
...
$(document).ready(function(){
    ...
    (function (){
        ...
        $("#stdDev").text(stdDev);//output sd to div on page
    })();

    function storeTblValues(){
        var TableData = new Array();
        $('#DataTables_Table_0 tr').each(function(row, tr){
