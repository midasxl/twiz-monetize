...
if (strpos($raceinfotext, 'SIMULCAST') !== false){
    ...
    <thead><tr>
        ...
        <th class="tooltip tooltip-top" data-tooltip="Pr">Pr</th>

        <th class="tooltip tooltip-top" data-tooltip="Checkbox">__</th>

        <th class="tooltip tooltip-top" data-tooltip="Name">Name</th>

        <th class="tooltip tooltip-top" data-tooltip="m/e">m/e<b/th>

        <th class="tooltip tooltip-top" data-tooltip="Ml">Ml</th>

        <th class="tooltip tooltip-top" data-tooltip="J/T">J/T</th>
        ...
        <th class="tooltip tooltip-top" data-tooltip="Lr">Lr</th>

        <th class="tooltip tooltip-top" data-tooltip="Rf">Rf</th>

        <th class="tooltip tooltip-top" data-tooltip="Jk">Jk</th>

        <th class="tooltip tooltip-top" data-tooltip="Tr">Tr</th>

        <th class="tooltip tooltip-top" data-tooltip="Hr">Hr</th>

        <th class="tooltip tooltip-top" data-tooltip="Cl">Cl</th>

        <th class="tooltip tooltip-top" data-tooltip="Sp">Sp</th>

        <th class="tooltip tooltip-top" data-tooltip="Twiz">Twiz</th>
    ...
    */
    ...
    (function (){
      ...
      for(var i = 0; i < raceTally; i++) {
          ...
          $("#stdDevTotal" + i).text(stdDev);//output sd to div on page
