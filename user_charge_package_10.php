	...
	if(isset($_POST['customer_id'])){ // if this is set, then the customer already exists...
		try {
			$charge = Stripe_Charge::create(array(
				...
				'description' => "Ten credit purchase"
			));
...
<html lang="en">
<head>
<title>Thoroughwiz | User Purchase 10 Credit Package</title>
<!-- Meta Data -->
...
<div class="wrapper">
  ...
  <div class="breadcrumbs">
    <div class="container">
      <h1 class="pull-left">10 Credit Package</h1>
      <ul class="pull-right breadcrumb">
        <li><a href="index.php">Home</a></li>
        <li class="active">10 Credit Package</li>
      </ul>
    </div>
  </div>
  <!--/breadcrumbs-->
    ...
    <div class="row">
        <?php
			...
			if ($charge->paid == true) {
				...
				// add ten credits to this users credit tally, to be used at their discretion
					addCredit(10, $loggedInUser->user_id);
				...
				echo '
					...
					<div class="headline">
						  <div class="col-md-7" style="margin-bottom:20px;">
							  <div style="margin-bottom:30px;">
								  ...
								  <h4 style="color:#74c52c;position:relative;left:30px;">Receipt for your 10 credit package purchase</h4>
							  </div>
							  <p>Hello '.$loggedInUser->email.',<br>
							  We have received your 10 credit package purchase payment of $'.$amount.'0.  10 credits have been added to your account to be used at your discretion.</p>
					...
					<p>If you do not want to run your sheet at this time, 10 credits have been added to your account.  You can use these credits at your discretion.  Credit tallies are available on your home page.</p>
