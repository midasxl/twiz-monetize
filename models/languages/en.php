...
$lang = array_merge($lang,array(
	...
	"ACCOUNT_SPECIFY_EMAIL"			=> "Please provide your valid registered email address",
	"ACCOUNT_INVALID_EMAIL"			=> "Please provide a properly formatted and valid email address",
	"ACCOUNT_EMAIL_NOT_IN_DB"		=> "There is no account associated with the email address you provided",
	...
	"ACCOUNT_INVALID_DATA"			=> "You have provided invalid data",
	"ACCOUNT_ALREADY_ACTIVE"		=> "Your account is already in an active status",
	"ACCOUNT_INACTIVE"			=> "Your account is not yet active.<br><br>Please check your email / spam folder for account activation instructions, or request new activation instructions",
	...
	"ACCOUNT_EMAIL_IN_USE"			=> "The email you provided, %m1% is already in use",
	"ACCOUNT_LINK_ALREADY_SENT"		=> "A request to activate has already been sent to this email address in the last %m1% hour(s)",
	"ACCOUNT_NEW_ACTIVATION_SENT"		=> "We have sent instructions on how to activate your account to the email address you provided",
	...
	"ACCOUNT_USER_INVALID_CHARACTERS"	=> "Username can only contain alpha-numeric characters",
	"ACCOUNT_FIRST_NAME_INVALID_CHARACTERS"  => "First Name can only contain alpha characters",
	"ACCOUNT_LAST_NAME_INVALID_CHARACTERS"  => "Last Name can only contain alpha characters",
...
$lang = array_merge($lang,array(
	...
	"SQL_ERROR"				=> "The server has experienced a fatal error, please try again",
...
$lang = array_merge($lang,array(
	...
	"PERMISSION_CREATION_SUCCESSFUL"	=> "Successfully created new permission level<br><br>Permission Level: %m1%",
